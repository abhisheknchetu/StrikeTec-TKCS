package com.calendarlibarary.caldroid;
...
import com.calendarlibarary.R;
import com.calendarlibarary.infiniteviewpager.InfinitePagerAdapter;
import com.calendarlibarary.infiniteviewpager.InfiniteViewPager;
...
public class CaldroidFragment extends DialogFragment {
    ...
    public VerticalTransformer verticaltransformer = new VerticalTransformer();
    ...
    public int getPagerNumber () {
        return dateViewPager.getCurrentItem();
    }
     ...
     */
    public TextView getYearTitleTextView () {
        return yearTitleTextView;
    }

    public void setYearTitleTextView(TextView yearTitleTextView){
    ...
    protected void refreshMonthTitleTextView() {
        ...
        String monthyearTitle = DateUtils.formatDateRange(getActivity(),
                monthYearFormatter, millis, millis, MONTH_YEAR_FLAG).toString();

        String[] monthyear = monthyearTitle.split(" ");
        String monthTitle = monthyear[0];
        String yearTitle = monthyear[1];

        monthTitleTextView.setText(monthTitle.toUpperCase(Locale.getDefault()));
        yearTitleTextView.setText(yearTitle);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        monthTitleTextView = (TextView) view
                .findViewById(R.id.calendar_month_textview);

        yearTitleTextView = (TextView)view.findViewById(R.id.calendar_year_textview);
    ...
    private void setupDateGridPages(View view) {
        ...
        dateViewPager.setPageTransformer(false, verticaltransformer);

//        dateViewPager.setOrientation(DirectionalViewPager.VERTICAL);
    }
