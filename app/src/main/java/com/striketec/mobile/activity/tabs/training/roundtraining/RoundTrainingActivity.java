...
public class RoundTrainingActivity extends BaseTrainingActivity implements UploadFinishCallback{
    ...
    @OnClick({R.id.starttraining, R.id.back, R.id.audiobtn, R.id.left_sensor_connection_layout, R.id.right_sensor_connection_layout})
    ...
    private void initViews(){
        ...
        titleView.setText(getResources().getString(R.string.roundtraining_title));
                    ...
                    public void run() {
                        if (currentTime == 0){
                            if (currentStatus == 0){
                                ...
                                resetPunchDetails();
                                if (roundvalue == 1)
                                    mainActivityInstance.startTrainingSession(AppConst.TRAINING_TYPE_ROUND, -1);
                            ...
                            currentTime--;
                            if (AppConst.SENSOR_DEBUG && currentStatus == 1)
    ...
    public void syncFinished() {
        endLoading();
        mainActivityInstance.getSessionsWithType(AppConst.TRAINING_TYPE_ROUND, true);
    }
